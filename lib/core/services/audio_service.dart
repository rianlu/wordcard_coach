...
class AudioService {
  ...
  final AudioPlayer _audioPlayer = AudioPlayer(); // 说明：逻辑说明
  ...
  Future<void> init() async {
    ...
    try {
        ...
        await _sfxCorrect.setReleaseMode(ReleaseMode.stop); // 说明：逻辑说明
  ...
  Future<void> playAsset(String fileName) async {
    try {
       ...
       if (fileName.contains('correct')) {
           ...
           await _sfxCorrect.resume(); // 说明：逻辑说明
